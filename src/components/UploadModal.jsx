                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                className="w-full h-10 rounded-lg border border-slate-300 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    ...
                    <div>
                        ...
                        >
                            {['Notes', 'Module', 'Question Paper', 'Question Set'].map(t => <option key={t} value={t}>{t}</option>)}
                        </select>
                    </div>

                    <div className="pt-2">
                        <label className="block text-sm font-medium text-slate-700 mb-1">Upload PDF *</label>
                        <div className="border-2 border-dashed border-slate-200 rounded-xl p-6 hover:bg-slate-50 transition-colors text-center cursor-pointer relative group">
                            <input
                                type="file"
                            ...
                            {file ? (
                                <div className="flex flex-col items-center text-blue-600">
                                    ...
                                    <span className="text-sm font-medium truncate max-w-full px-4">{file.name}</span>
                                ...
                                <div className="flex flex-col items-center text-slate-400 group-hover:text-slate-500">
                                    ...
                                    <span className="text-xs mt-1">PDF only, max 10MB</span>
                                </div>
                            )}
                        </div>
                    </div>
